...
export async function POST(request: NextRequest) {
  try {
    ...
    await recordAdminAuditEvent({
      ...
      details: "Tested AppByMari connection; API key and remote balance were excluded",
    ...
    return noStoreJson({
      ...
      message: responseStatus === 401
        ...
        : "เชื่อมต่อ AppByMari ไม่สำเร็จ กรุณาตรวจสอบ API endpoint และลองใหม่",
    }, responseStatus);
  }
}
