 ...
 * Maps members in "Appbymari หลังบ้าน" by LINE Unique User ID to their respective Tier,
...
- 🚨 กฎเหล็กการเงิน: ในกลุ่ม "Appbymari หลังบ้าน" ห้ามพิมพ์ตัวเลขหลังบ้านเกี่ยวกับการเงิน (ยอดขายบาท, กำไร, ต้นทุน, ยอดเติมเงิน) โชว์โดยไม่ได้รับอนุญาตจากปะป๊า (Tier SSS) เด็ดขาด! หากหม่ามี้ถามเรื่องยอดขาย ให้สรุปเป็น "จำนวนออเดอร์" หรือ "จำนวนผู้ใช้" แทน และบอกอย่างน่ารักว่าตัวเลขเงินต้องให้ป๊าอนุญาตก่อนค่า`,
...
- 🚨 กฎเหล็กการเงิน: ในกลุ่ม "Appbymari หลังบ้าน" ห้ามพิมพ์ตัวเลขหลังบ้านเกี่ยวกับการเงิน (ยอดขายบาท, กำไร, ต้นทุน, ยอดเติมเงิน) โชว์โดยไม่ได้รับอนุญาตจากปะป๊า (Tier SSS) เด็ดขาด! หากถามให้ปฏิเสธอย่างน่ารักว่าเรื่องตัวเลขการเงินต้องขออนุญาตป๊าก่อนน้าา`,
    canAccessDeepFinance: false,
    canManageSystem: false,
  },
