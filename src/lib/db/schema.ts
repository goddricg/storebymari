...
export const supportCases = mysqlTable("support_cases", {
  ...
  centerCaseId: varchar("center_case_id", { length: 128 }),
  centerCaseCode: varchar("center_case_code", { length: 100 }),
  centerSyncedAt: datetime("center_synced_at", { fsp: 6 }),
  centerSyncError: text("center_sync_error"),
